...
# Token de serviço dedicado ao provisionamento automático de clientes
# (POST /v1/internal/provisioning/ensure-cliente). Vazio = endpoint
# responde 503 (fail-closed, nunca aberto).
PROVISIONING_TOKEN = os.getenv("MOTOR_PROVISIONING_TOKEN", "")
