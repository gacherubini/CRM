...
- `.claude/worktrees/motor-multisimulacao-sem-travar/catalogo-publico/fly.toml` -> `catalogo2037`
- `.claude/worktrees/motor-multisimulacao-sem-travar/chatbot-api/fly.toml` -> `chatbot2037`
- `.claude/worktrees/motor-multisimulacao-sem-travar/deploy/fly/evolution/fly.toml` -> `evolution2037`
- `.claude/worktrees/motor-multisimulacao-sem-travar/deploy/fly/n8n/fly.toml` -> `n8n2037`
- `.claude/worktrees/motor-multisimulacao-sem-travar/estoque-api/fly.toml` -> `estoque2037`
- `.claude/worktrees/motor-multisimulacao-sem-travar/motor-simulacao/fly.toml` -> `motor2037`
- `.claude/worktrees/motor-multisimulacao-sem-travar/portal-gestao/fly.toml` -> `portal2037`
