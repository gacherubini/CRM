...
- `.claude/worktrees/audio-atendimento/catalogo-publico/fly.toml` -> `catalogo2037`
- `.claude/worktrees/audio-atendimento/chatbot-api/fly.toml` -> `chatbot2037`
- `.claude/worktrees/audio-atendimento/deploy/fly/evolution/fly.toml` -> `evolution2037`
- `.claude/worktrees/audio-atendimento/deploy/fly/n8n/fly.toml` -> `n8n2037`
- `.claude/worktrees/audio-atendimento/estoque-api/fly.toml` -> `estoque2037`
- `.claude/worktrees/audio-atendimento/motor-simulacao/fly.toml` -> `motor2037`
- `.claude/worktrees/audio-atendimento/portal-gestao/fly.toml` -> `portal2037`
- `.claude/worktrees/ci-pipeline/catalogo-publico/fly.toml` -> `catalogo2037`
- `.claude/worktrees/ci-pipeline/chatbot-api/fly.toml` -> `chatbot2037`
- `.claude/worktrees/ci-pipeline/deploy/fly/evolution/fly.toml` -> `evolution2037`
- `.claude/worktrees/ci-pipeline/deploy/fly/n8n/fly.toml` -> `n8n2037`
- `.claude/worktrees/ci-pipeline/estoque-api/fly.toml` -> `estoque2037`
- `.claude/worktrees/ci-pipeline/motor-simulacao/fly.toml` -> `motor2037`
- `.claude/worktrees/ci-pipeline/portal-gestao/fly.toml` -> `portal2037`
...
- `.claude/worktrees/motor-motrix-pan/catalogo-publico/fly.toml` -> `catalogo2037`
- `.claude/worktrees/motor-motrix-pan/chatbot-api/fly.toml` -> `chatbot2037`
- `.claude/worktrees/motor-motrix-pan/deploy/fly/evolution/fly.toml` -> `evolution2037`
- `.claude/worktrees/motor-motrix-pan/deploy/fly/n8n/fly.toml` -> `n8n2037`
- `.claude/worktrees/motor-motrix-pan/estoque-api/fly.toml` -> `estoque2037`
- `.claude/worktrees/motor-motrix-pan/motor-simulacao/fly.toml` -> `motor2037`
- `.claude/worktrees/motor-motrix-pan/portal-gestao/fly.toml` -> `portal2037`
- `.claude/worktrees/simulacoes-job-bancos/catalogo-publico/fly.toml` -> `catalogo2037`
- `.claude/worktrees/simulacoes-job-bancos/chatbot-api/fly.toml` -> `chatbot2037`
- `.claude/worktrees/simulacoes-job-bancos/deploy/fly/evolution/fly.toml` -> `evolution2037`
- `.claude/worktrees/simulacoes-job-bancos/deploy/fly/n8n/fly.toml` -> `n8n2037`
- `.claude/worktrees/simulacoes-job-bancos/estoque-api/fly.toml` -> `estoque2037`
- `.claude/worktrees/simulacoes-job-bancos/motor-simulacao/fly.toml` -> `motor2037`
- `.claude/worktrees/simulacoes-job-bancos/portal-gestao/fly.toml` -> `portal2037`
