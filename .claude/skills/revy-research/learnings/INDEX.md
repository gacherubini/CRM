...
| esconder um `<svg>` com hidden e ele continuar aparecendo | `2026-08-30-hidden-nao-esconde-svg.md` |
| ler opacidade por script numa folha com `transition` e receber valor do meio | `2026-08-30-getcomputedstyle-le-o-meio-da-transicao.md` |
| caixa de componente sai vazia, e as fichas aparecem numa caixa com nome de pasta | `2026-08-30-modulo-no-dominio-devolve-a-arvore-de-pastas.md` |
