...
export CHATBOT_AUDIO_EVOLUTION_URL="${CHATBOT_AUDIO_EVOLUTION_URL:-http://evolution2037.flycast:8080}"
export CHATBOT_IMAGE_EVOLUTION_URL="${CHATBOT_IMAGE_EVOLUTION_URL:-http://evolution2037.flycast:8080}"
