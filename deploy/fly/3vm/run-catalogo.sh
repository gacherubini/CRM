...
# 3-VM: catálogo atrás de https://app2037.fly.dev/loja
export CATALOGO_PUBLIC_BASE_URL="${CATALOGO_PUBLIC_BASE_URL:-https://app2037.fly.dev/loja}"
export CATALOGO_URL_PREFIX="${CATALOGO_URL_PREFIX:-/loja}"
