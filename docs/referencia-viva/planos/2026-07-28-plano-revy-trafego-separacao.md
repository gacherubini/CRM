...
> Spec: [`docs/referencia-viva/specs/2026-07-28-revy-trafego-separacao-portal-design.md`](../specs/2026-07-28-revy-trafego-separacao-portal-design.md)
...
|---:|---|---|---|
| **1** | [Fase 1](../planos/2026-07-28-revy-trafego-fase1-app-multi-loja.md) | Cockpit Revy + cliente sem menus técnicos | **CÓDIGO FEITO** |
| **2** | [Fase 2](../planos/2026-07-28-revy-trafego-fase2-api-cutover.md) | API + flags portal + pixel URL catálogo | **CÓDIGO FEITO** (flags off) |
...
`docs/referencia-viva/handoff-contexto.md`.
...
| `docs/nao-plano/tutoriais/trafego-pago-loja.md` | Cliente: setup via equipe Revy |
| `docs/referencia-viva/contexto-compacto.md` | Eixo C → deploy/cutover |
| `portal-gestao/README.md` | Atualizar: UI técnica saiu do dono |
| `docs/nao-plano/tutoriais/fluxo-utm-pixel-ctwa-meta.md` | Atualizar dono do Pixel quando cutover |
