...
> `docs/referencia-viva/planos/2026-07-22-plano-menu-estoque-wa-e-fotos-fix.md`.
...
**Files:**
- Modify: `docs/referencia-viva/contexto-compacto.md` (nota curta do novo fluxo + head 0008)
...
Em `docs/referencia-viva/contexto-compacto.md`: na linha de migrations do Chatbot, trocar `0007` por `0008`; na tabela "Estado por produto", nota curta em Chatbot: "cadastro por número autorizado via gatilho `cadastro` + roteamento `/v1/operacao/roteamento`".

- [ ] **Step 3: Commit**

```bash
git add docs/referencia-viva/contexto-compacto.md
