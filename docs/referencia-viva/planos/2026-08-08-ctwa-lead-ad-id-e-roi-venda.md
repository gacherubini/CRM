...
| `docs/nao-plano/historico/README.md`, `docs/referencia-viva/handoff-contexto.md` | Task 7 |
...
- [ ] **Step 5:** atualizar `docs/nao-plano/historico/README.md` e `docs/referencia-viva/handoff-contexto.md`
