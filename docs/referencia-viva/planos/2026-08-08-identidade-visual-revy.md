...
- **Spec:** `docs/referencia-viva/specs/2026-08-08-identidade-visual-revy-design.md`. Kit para pessoas de fora: `docs/nao-plano/brand/revy-brand-kit.md` v2.0.
...
- **Não mexer nos 13 itens recusados** em `docs/referencia-viva/2026-08-07-triagem-revisao-ux-loja-control.md`. Em especial: o card "Google Ads — Indisponível" (`L2`) e o "Simulações — em construção" no rodapé (`L6`) **ficam**.
...
| `docs/nao-plano/brand/assets/*.svg` | Marca em contorno. |
...
/* ===========================================================================
   ...
   Spec: docs/referencia-viva/specs/2026-08-08-identidade-visual-revy-design.md
   =========================================================================== */
:root {
  /* --- neutros --- */
  --paper: #f9f9f9;
...
- Create (gerados): `docs/nao-plano/brand/assets/revy-mark.svg`, `revy-mark-reverse.svg`, `revy-wordmark.svg`, `revy-signature.svg`, `revy-signature-reverse.svg`, `favicon.svg`
...
Expected: seis linhas `gerado: docs/nao-plano/brand/assets/...`
...
Abra `docs/nao-plano/brand/assets/revy-signature.svg` no navegador. O descritor deve ler
...
```bash
cp docs/nao-plano/brand/assets/revy-mark.svg site/assets/revy-mark.svg
cp docs/nao-plano/brand/assets/revy-wordmark.svg site/assets/revy-wordmark.svg
cp docs/nao-plano/brand/assets/revy-signature.svg site/assets/revy-signature.svg
cp docs/nao-plano/brand/assets/revy-signature-reverse.svg site/assets/revy-signature-reverse.svg
...
git add shared/brand/build_marca.py shared/brand/tests/test_marca.py \
        docs/nao-plano/brand/assets site/assets
...
**Interfaces:**
- Consumes: `revy-tokens.css` (Task 2), `docs/nao-plano/brand/assets/revy-mark.svg` (Task 3)
...
/* A marca e preta nos dois temas — nunca verde. O simbolo agora vem do SVG
   em docs/nao-plano/brand/assets; .brand-mark so posiciona. */
.brand-mark {
...
**Files:**
- Modify: `docs/nao-plano/brand/revy-brand-kit.md` (checklist da seção 8)
- Modify: `docs/referencia-viva/handoff-contexto.md`

- [ ] **Step 1: Marcar o checklist do kit**

Em `docs/nao-plano/brand/revy-brand-kit.md`, seção 8, marque como feitos os itens que este plano
...
Deixe em aberto o que continua pendente: `docs/nao-plano/brand/preview.html` e `index.html`
...
Em `docs/referencia-viva/handoff-contexto.md`, acrescente uma linha ao estado atual apontando para o
...
rg -n "<text" docs/nao-plano/brand/assets/ site/assets/
portal-gestao/.venv/Scripts/python.exe -m pytest shared/brand/tests -q
git diff --check
git status --short
```
...
```bash
git add docs/nao-plano/brand/revy-brand-kit.md docs/referencia-viva/handoff-contexto.md
