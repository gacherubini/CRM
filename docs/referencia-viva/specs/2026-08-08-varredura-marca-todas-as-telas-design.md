...
O plano de execução vive em `docs/referencia-viva/planos/2026-08-08-varredura-marca-todas-as-telas.md`.

**Não redefine nada de marca.** Cor, forma, tipo e regras de uso continuam sendo os do spec
anterior e de `docs/nao-plano/brand/revy-brand-kit.md` v2.0. Aqui só se decide *como* aquilo alcança o
produto inteiro.
...
- `docs/referencia-viva/specs/2026-08-08-identidade-visual-revy-design.md` — a marca e os tokens
- `docs/nao-plano/brand/revy-brand-kit.md` v2.0 — versão para pessoas de fora
- `docs/referencia-viva/2026-08-07-triagem-revisao-ux-loja-control.md` — o que não volta como proposta
