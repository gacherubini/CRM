...
|---|---|---|
| Onde ficam as telas de canal WhatsApp | **Revy Loja** (operação completa) | Contraria a matriz de donos do as-built (`docs/referencia-viva/design/2026-07-30-revy-control-loja-asbuilt-e-melhorias.md:126`, que atribui a UI ao Control). Motivo: quem tem o celular na mão para ler o QR de 60s é a loja, não o admin Revy. **O as-built precisa ser atualizado junto.** |
...
- `docs/referencia-viva/design/2026-07-30-revy-control-loja-asbuilt-e-melhorias.md:126` — dono da UI de canais passa a ser a Loja.
