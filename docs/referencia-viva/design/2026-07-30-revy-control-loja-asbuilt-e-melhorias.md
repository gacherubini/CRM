...
- [`docs/referencia-viva/specs/2026-07-29-revy-control-design.md`](../specs/2026-07-29-revy-control-design.md) (status original: “não implementado”)
- [`docs/referencia-viva/specs/2026-07-29-revy-loja-design.md`](../specs/2026-07-29-revy-loja-design.md)
**Planos de implementação:**
- [`docs/referencia-viva/planos/2026-07-29-plano-revy-control.md`](../planos/2026-07-29-plano-revy-control.md)
- [`docs/referencia-viva/planos/2026-07-29-plano-revy-loja.md`](../planos/2026-07-29-plano-revy-loja.md)
**ADR:** [`docs/referencia-viva/adr/0001-suspensao-distribuida.md`](../adr/0001-suspensao-distribuida.md)
...
1. **Google OAuth precisa de secrets GCP**
   Código de OAuth, ports HTTP, outbox e a **UI de operação** (conectar, escolher conta, vincular conversões e sincronizar métricas) estão implementados pela Parte B de `docs/referencia-viva/specs/2026-07-29-telas-canais-wa-google-design.md`. **Não há** projeto GCP/consent/developer token configurados no lab por este repositório. Sem o conjunto completo de `GOOGLE_ADS_*` secrets, a UI mostra “Google não configurado neste ambiente” e não oferece um botão que cairia no adapter fake.

   Pendência de ops: o `redirect_uri` registrado no Google Cloud Console e o secret `GOOGLE_ADS_OAUTH_REDIRECT_URI` apontam para o callback JSON `/control/v1/google-ads/oauth/callback` e precisam ser repontados **à mão** para a rota HTML `/app/control/google-ads/oauth/callback` (detalhes em `revy-trafego/README.md`, "Operação Google Ads no Control"). Sem isso o admin volta do Google em JSON cru ou toma `redirect_uri_mismatch`.
...
- ADR suspensão: `docs/referencia-viva/adr/0001-suspensao-distribuida.md`
