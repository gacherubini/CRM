...
O plano de execução vive em `docs/superpowers/plans/2026-08-08-identidade-visual-revy.md`.
O material para pessoas de fora (agência, designer, quem faz criativo) é
`docs/brand/revy-brand-kit.md` v2.0 — este spec é a versão para quem mexe no código.
...
6. **`docs/brand/revy-brand-kit.md` v1.0 descreve outro produto** — manda usar Inter, lista uma
...
| Arquivo | Conteúdo |
|---|---|
| `docs/brand/assets/revy-mark.svg` | Símbolo Bloco, `#1b1b1b`, R vazado em branco |
| `docs/brand/assets/revy-mark-reverse.svg` | Símbolo para fundo escuro, `#000000` + fio `rgba(255,255,255,.16)` |
| `docs/brand/assets/revy-wordmark.svg` | "Revy" em Hanken Grotesk **convertido em contorno** |
| `docs/brand/assets/revy-signature.svg` | Wordmark + descritor "GESTÃO DE REVENDA" |
| `docs/brand/assets/revy-signature-reverse.svg` | Idem, para fundo escuro |
| `docs/brand/assets/favicon.svg` + `favicon-32.png` + `apple-touch-icon-180.png` | Derivados do símbolo |
...
| `docs/brand/preview.html`, `index.html`, `portal-mock.html` ficam desatualizados | Marcados como legado no kit v2.0; regerar é trabalho separado |
...
- `docs/2026-08-07-triagem-revisao-ux-loja-control.md` — o que não pode voltar como proposta.
