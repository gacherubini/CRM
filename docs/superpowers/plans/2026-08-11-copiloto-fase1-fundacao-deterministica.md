...
**Spec:** `docs/superpowers/specs/2026-08-10-copiloto-negocio-loja-design.md` (revisão 2) — §3.7, §4.1, §4.4, §5, §6.2, §7, §9.
...
**Por que na v1 (§4.2):** é a única pergunta que nenhum concorrente responde e é literalmente a frase de abertura do script de outbound (`docs/vendas/script-venda-outbound.md:79-80`). Lê snapshot local (`Venda.campanha_id_first/last`, `models.py:126-129`) — **não** depende do Revy Tráfego estar de pé, ao contrário de `roi_canais`.
...
- [ ] Atualizar `docs/plans/README.md` com a linha do Copiloto Fase 1
