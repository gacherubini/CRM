...
**Spec:** `docs/superpowers/specs/2026-07-28-revy-trafego-separacao-portal-design.md`  
**Roadmap:** `docs/plans/2026-07-28-plano-revy-trafego-separacao.md`
...
| `docs/trafego-pago-loja.md` | Guia cliente só resultados |
...
**Files:**
- Modify: `docs/trafego-pago-loja.md` — seção setup vira “Revy configura”; cliente só lê resultados.
- Create: `docs/revy-trafego-interno.md` — guia equipe (login, seletor, Pixel, campanhas, ROI, diagnóstico).
- Modify: `docs/contexto-compacto.md` — eixo C aponta este plano.
- Modify: `docs/plans/README.md` — entrada 6.4 Revy Tráfego.
