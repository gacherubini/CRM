...
**Spec:** `docs/superpowers/specs/2026-07-29-telas-canais-wa-google-design.md` (Parte A)
...
**Files:**
- Modify: `docs/design/2026-07-30-revy-control-loja-asbuilt-e-melhorias.md:126`
...
```bash
git add docs/design/2026-07-30-revy-control-loja-asbuilt-e-melhorias.md revy-trafego/README.md deploy/fly/3vm/env.example portal-gestao/README.md
