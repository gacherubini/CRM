...
**Fora (não mexer agora):** qualidade da resposta da IA — memória/histórico injetado no prompt, saudação inteligente, tool de estoque. Isso é o eixo 3 do diagnóstico (`docs/diagnostico-bot-whatsapp-2026-08-03.md`) e vira plano próprio.
...
- `docs/diagnostico-bot-whatsapp-2026-08-03.md` — **Modify**: marca correções (1) gate e (2) handoff como aplicadas e aponta pro plano/teste.
...
- Modify: `docs/diagnostico-bot-whatsapp-2026-08-03.md`
...
Editar `docs/diagnostico-bot-whatsapp-2026-08-03.md`, seção "5. Correções recomendadas": marcar (1) exceção de gate e (2) handoff como **feitas** neste plano, e na tabela da seção 7 mudar "(1)–(2)" para "aplicadas em `docs/superpowers/plans/2026-08-03-gate-bot-somente-leads-virgens.md`; (3)–(5) pendentes". Acrescentar uma linha apontando o teste `n8n/test_gate_somente_nao_salvos.js`. Registrar em uma frase o trade-off do fail-open (ver seção "Risco" abaixo).

- [ ] **Step 4: Commit**

```bash
git add n8n/validate_workflow.py docs/diagnostico-bot-whatsapp-2026-08-03.md
