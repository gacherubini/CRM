...
| Guia loja tráfego | `docs/nao-plano/tutoriais/trafego-pago-loja.md` | Feito — **estender** seção CTWA |
...
| `docs/nao-plano/tutoriais/trafego-pago-loja.md` | Seção CTWA + playbook Pixel→públicos→CTWA |
| `docs/nao-plano/tutoriais/tutorial-dono.md` | Parágrafo operacional |
| `docs/referencia-viva/contexto-compacto.md` + `plans/README.md` | Índice / eixo |
...
- `docs/nao-plano/tutoriais/trafego-pago-loja.md` com seções:
