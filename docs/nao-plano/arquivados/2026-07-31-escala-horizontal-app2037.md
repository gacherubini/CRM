...
if settings.database_url.startswith("sqlite"):
    ...
    # Ver docs/nao-plano/arquivados/2026-07-31-escala-horizontal-app2037.md, Task C1.
...
`docs/referencia-viva/contexto-compacto.md` e `docs/referencia-viva/handoff-contexto.md` — registrar:
...
```bash
git add deploy/fly/3vm/README.md docs/referencia-viva/contexto-compacto.md docs/referencia-viva/handoff-contexto.md
