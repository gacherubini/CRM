...
> - Estado Motor: `docs/referencia-viva/planos/2026-07-11-plano1a-motor-simulacao-independente.md`
...
- Playwright é **último recurso** (só porque o Santander não tem API) — ver design `docs/referencia-viva/planos/2026-07-13-plano1a-task12-santander-design.md`.
