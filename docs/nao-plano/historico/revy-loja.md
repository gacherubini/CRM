...
(`docs/nao-plano/historico/revy-control.md` → "Atribuição de venda no ROI"). Essa linha é o **seu
...
Detalhe: `docs/referencia-viva/2026-08-02-provisionamento-loja-entitlements.md`.
