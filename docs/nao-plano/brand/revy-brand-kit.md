...
> **não mudaram**. Decisões e escopo técnico: `docs/referencia-viva/specs/2026-08-08-identidade-visual-revy-design.md`.
...
- [ ] `docs/nao-plano/brand/preview.html` e `index.html` regerados (hoje mostram a paleta da v1.0)
