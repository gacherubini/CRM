...
- Create: `docs/nao-plano/historico/2026-XX-XX-resultado-worker-ip-residencial.md`
...
Escreva o resultado medido em `docs/nao-plano/historico/`, e atualize a seção "Worker em IP residencial" de `motor-simulacao/README.md` de **PLANEJADO** para o estado real, movendo a narrativa para o histórico e deixando no README só as invariantes (é o corte que o CLAUDE.md exige: invariante fica, história sai).

```bash
git add motor-simulacao/README.md docs/nao-plano/historico/
