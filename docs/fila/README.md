...
| WhatsApp dois modos | Spec fechada em [`../referencia-viva/specs/2026-08-12-whatsapp-dois-modos-design.md`](../referencia-viva/specs/2026-08-12-whatsapp-dois-modos-design.md). Plano de implementação ainda não escrito. Oferta 1:1 / faixa Aguardando / card do Agente saem nesse plano, em cima do B1 do sino — incluindo a **migration de destinatário** no sinal. |
