...
| [Modo 2 / Card 2 — fila e rodízio](2026-08-13-wa-modo2-2-chatbot-fila-e-rodizio.md) | Chatbot | `fila_vendedor` + `oferta_lead` + ponteiro rotativo, trava idempotente, worker de 10 min, gate de suspensão, HTTP da fila. Não manda mensagem — isso é o card 2b. |
| [Modo 2 / Card 2b — bot e mensagens](2026-08-13-wa-modo2-2b-chatbot-bot-e-mensagens.md) | Chatbot | Adapters Cloud nos ports que já existem: mídia pelo Graph, outbound com os 2 envelopes, 3 gatilhos, clique→trava, re-notificação e follow-up. **Depende do card 2.** |
| [Modo 2 / Card 3 — webhook da Meta](2026-08-13-wa-modo2-3-n8n-cloud-e-webhook.md) | Chatbot / n8n | Assinatura e parse em Python; `n8n-cloud` é transporte fino (GET verify + POST rawBody). Validador novo. **Depende dos cards 2 e 2b.** |
| [Modo 2 / Card 4 — toggle no Control](2026-08-13-wa-modo2-4-control-toggle.md) | Control / Chatbot | `whatsapp_modo` na loja (1 XOR 2 no banco), emitido como aggregate no snapshot, escolha na ficha atrás de flag. Fecha o gate do chatbot. **Depende do card 2.** |
