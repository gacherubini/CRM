...
|---|---|---|
| [Venda na loja errada + redesign Estoque e Vitrine](2026-09-09-loja-venda-loja-errada-e-redesign-estoque-vitrine.md) | Loja | Task 1 (venda de outra loja aparecendo na `teste`) pronta na branch `loja-venda-redesign` com regressão de dois slugs (`tests/test_vendas_loja_ativa.py`); redesign em andamento (Estoque e Atendimento no branch). |
