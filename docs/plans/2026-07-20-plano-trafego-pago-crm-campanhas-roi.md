...
| Arquivo | Responsabilidade |
|---|---|
| `docs/plans/README.md` | Entrada no índice |
| `docs/contexto-compacto.md` | Checkpoint eixo C |
| `docs/trafego-pago-loja.md` | Guia operacional do dono (UTM + custo + Pixel) |
...
**Files:**
- Create: `docs/trafego-pago-loja.md`
- Modify: `docs/plans/README.md` — linha do plano
- Modify: `docs/contexto-compacto.md` — eixo C cita este plano
- Modify: `#3B` topo — Task 5 “detalhada em 2026-07-20-plano-trafego…”
- Modify: `#6` E8 — “implementação: plano 2026-07-20…”

Conteúdo mínimo de `docs/trafego-pago-loja.md`:
