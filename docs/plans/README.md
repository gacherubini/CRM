...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / CÓDIGO AVANÇADO** — F0–2 + F3 Meta/readiness + F4A Google skeleton + F5 canais + F6 dashboard; residual = lab + F4B–D + F5 connect/QR + F7 |
