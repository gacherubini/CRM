...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / F2+F3-lean** — projeção 5 destinos, gates WA/venda, readiness; residual lab + integrações Meta completas |
