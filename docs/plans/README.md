...
| 6.6 | [Revy Loja](2026-07-29-plano-revy-loja.md) | Portal → Vendas + Estoque; Atendimento, Chatbot, Multibanco e Seller AI | **ATIVO / CÓDIGO F0–F6+F8 LEAN** — shell, overviews, atendimento multi-canal, equipe read-only, bancos, Evolution send, redirects; residual F7 Seller AI + lab |
