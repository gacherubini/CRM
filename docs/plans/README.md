...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 PARCIAL-AVANÇADO** — identidade, snapshot+outbox+enqueue+worker opt-in, piloto Chatbot (gate 423); fan-out e rollout pendentes |
