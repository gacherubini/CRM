...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 PARCIAL-AVANÇADO** — identidade canônica, snapshot+outbox, piloto Chatbot (projeção+gate 423), UI comercial; worker/fan-out e rollout pendentes |
