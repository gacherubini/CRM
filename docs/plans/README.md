...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 PARCIAL-AVANÇADO** — domínio/APIs, portfólio, snapshot, UI base read-only e 209 testes; formulários, entrega/gates, rollout/deploy pendentes |
