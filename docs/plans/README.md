...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / CÓDIGO F0–6 product surface** — Google métricas CPL/ROAS + conversion-actions + `aquisicao-resumo` Loja + dashboard 7d; residual = GCP/token humano, E2E lab, F4C click IDs, F7 flags/smoke, worker outbox/poll Google |
