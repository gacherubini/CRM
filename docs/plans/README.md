...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 AVANÇADO** — fan-out Chatbot+Estoque+Portal, import Portal, gates; Motor/Catálogo e rollout pendentes |
