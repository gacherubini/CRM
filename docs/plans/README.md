...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 PARCIAL-AVANÇADO** — login canônico, prontidão com Dono ativável, snapshot com pessoas/cargos, UI comercial e 215 testes; entrega aos destinos e rollout pendentes |
