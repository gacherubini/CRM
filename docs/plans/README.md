...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 QUASE FECHADO** — fan-out 5 destinos, import, isolamento, gates; residual = rollout lab + gates finos |
