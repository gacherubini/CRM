...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / CÓDIGO F0–6 LEAN** — F3 aceite alerta + ativação gated; F6 overview rico; residual = lab + F4B–D + F5 connect/QR + F7 deploy |
