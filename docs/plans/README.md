...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / LOCAL 0–2 PARCIAL-AVANÇADO** — outbox+retry+worker; fan-out Chatbot+Estoque com gates 423; Portal/Motor/Catálogo e rollout pendentes |
