...
| 3 | [Plano #2A](2026-07-11-plano2a-chatbot-standalone-revendivel.md) | Chatbot + Estoque Lite | API+E3+E5+sessão de fotos+sim+n8n; **roteamento 3 casos** (só contato novo = IA; equipe = cadastro); go-live E2E residual |
