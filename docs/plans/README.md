...
| 6.6 | [Revy Loja](2026-07-29-plano-revy-loja.md) | Portal → Vendas + Estoque; Atendimento, Chatbot, Multibanco e Seller AI | **ATIVO / CÓDIGO F0–F4 LEAN** — shell+entitlements, estoque/vendas overview, atendimento; residual F5–F8 |
