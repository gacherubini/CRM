...
| 6.5 | [Revy Control](2026-07-29-plano-revy-control.md) | Lojas, RBAC, módulos, Google Ads, integrações, auditoria e Multi-WhatsApp | **ATIVO / CÓDIGO F0–6 LEAN** — F5 n8n multi-WA com instance dinâmica (1 workflow); RBAC sem slug manual; residual = lab + F4B–D adapters GCP + F7 deploy/smoke |
